...
export default function Login (props) {
  ...
  const [hidePassword, setHidePassword] = useState(true); // Se inicializa en 'true' para ocultar la contraseña por defecto
    ...
    <View style={styles.container}>
      <View style={styles.loginContainer}>
        <Image
          ...
          style={styles.logo}
        />
        <Text style={styles.loginTitulo}>Para acceder Ingresa</Text>
